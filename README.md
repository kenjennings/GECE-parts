...
One choice is to make the playfield more narrow -- ten color clocks per brick would provide an extra 7 color clocks of distance at the beginning of the line which may be enough.  Alternatively, going to a narrow width screen (16 bytes per line, 128 color clocks) would be 9 color clocks per each brick, a few less sycles of DMA time, and 16 color clocks of distance at the beginning of the line.  A narrow screen would also be more like the aspect ration of the original arcade game.  Either way it would require refactoring all of the playfield graphics.  Not looking forward to that.  Maybe in a later version after the game is completely functional.  
